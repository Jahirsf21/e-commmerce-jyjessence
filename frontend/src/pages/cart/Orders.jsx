...
const Orders = () => {
  ...
  const [filtro, setFiltro] = useState('todos'); // todos, pendiente, confirmado, enviado, entregado
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {pedidos.length === 0 ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">¡Haz tu primera compra y aparecerá aquí!</p>
          </div>
        ) : (
          <>
            {/* Filtros */}
            <div className="mb-6 flex flex-wrap gap-2">
              {['todos', 'pendiente', 'confirmado', 'enviado', 'entregado'].map((estado) => (
                <button
                  key={estado}
            ...
            <div className="space-y-4">
              {pedidosFiltrados.map((pedido) => (
                <div key={pedido.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 border-b border-gray-200">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {pedido.estadoPago && (
                          <span className={`text-sm font-medium ${obtenerColorEstadoPago(pedido.estadoPago)}`}>
                            💳 {pedido.estadoPago}
                          </span>
                        )}
                      </div>
                  ...
                  <div className="p-6">
                    {/* Dirección de Envío */}
                    <div className="mb-4">
                      <h4 className="text-sm font-semibold text-gray-700 mb-2">📍 Dirección de Envío</h4>
                    ...
                    {pedido.montoTotal && (
                      <div className="mb-4 p-3 bg-purple-50 rounded-lg">
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-semibold text-gray-700">💰 Monto Total:</span>
                        ...
                        {pedido.metodoPago && (
                          <div className="flex justify-between items-center mt-2">
                            ...
                            <span className="text-xs text-gray-800 font-medium">{pedido.metodoPago}</span>
                          </div>
                        )}
                      </div>
                    )}
              ...
              {pedidosFiltrados.length === 0 && (
                <div className="bg-white rounded-lg shadow-md p-8 text-center">
                  <p className="text-gray-600">No hay pedidos con el estado "{filtro}"</p>
                </div>
              )}
            </div>
          </>
